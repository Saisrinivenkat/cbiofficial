        ...
        <div className="grid-temp  h-screen bg-friends bg-center bg-cover bg-no-repeat">
          ...
          <div className=" col-span-5">
            <div className="flex flex-col items-center justify-center h-full">
              <h1 className="font-rhyme text-4xl font-bold text-gray-50 tracking-widest">CBI</h1>
              <h2 className="font-rhyme font-medium tracking-wider text-1xl text-white pt-6">THE NOTORIOUS GANG</h2>
              <h2 className="font-rhyme font-medium text-1xl tracking-wider text-white pt-6 pb-10">MANDA PATHIRAM</h2>
            </div>
          </div>
        </div>
      </div>
    ...
    <header className={`col-span-5 ${bgcolor}`}>
      ...
      <nav>
        <ul className={`md:flex md:text-white md:flex-row justify-center flex-col  ${view}`}>
          <li className="text-center text-2xl p-3 hover:bg-red-300 transition duration-300"><Link to="/" >Home</Link> </li>
          <li className="text-center p-3 text-2xl hover:bg-red-300"><Link to="/bday" >Birthdays</Link> </li>
        </ul>
      </nav>
    </header>
  );
