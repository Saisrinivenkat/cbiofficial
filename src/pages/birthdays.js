...
export default function Birthdays({user}) {
  ...
  return (
    <main className="min-h-screen h-full bg-friends bg-center bg-cover flex items-center justify-center ">
      ...
      <section className='my-14 mx-14 sm:mx-8 py-6 px-4 md:px-8 max-w-sm bg-white shadow-2xl space-y-2 '>
        <h3 className="p-2 text-center text-indigo-500 font-bold sm:text-base md:text-xl border-2 bg-gray-200 cursor-pointer"> Birthdays </h3>
        <List data={user} />
